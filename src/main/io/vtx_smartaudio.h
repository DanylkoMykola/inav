...
#define VTX_SMARTAUDIO_MAX_BAND 8
...
#define VTX_SMARTAUDIO_MAX_POWER_COUNT 6
#define VTX_SMARTAUDIO_DEFAULT_POWER_COUNT 6
#define VTX_SMARTAUDIO_DEFAULT_POWER 1

#define VTX_SMARTAUDIO_MIN_FREQUENCY_MHZ 4980        //min freq in MHz
