...
// 5.8 GHz
#define VTX_TRAMP_5G8_BAND_COUNT        8
#define VTX_TRAMP_5G8_CHANNEL_COUNT     8

#define VTX_TRAMP_5G8_MAX_POWER_COUNT   4
#define VTX_TRAMP_5G8_DEFAULT_POWER     1

#define VTX_TRAMP_5G8_MIN_FREQUENCY_MHZ 4950             //min freq in MHz
#define VTX_TRAMP_5G8_MAX_FREQUENCY_MHZ 6100             //max freq in MHz
